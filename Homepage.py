...
def run():
    with st.sidebar:
        app = option_menu(
            ...
            options=['Home','Chatbot','Email_Summarizer','MOM', 'TA Picture GPT', 'PDF GPT'],
            icons=['house-fill','wechat','envelope-at', 'images', 'filetype-pdf'],
